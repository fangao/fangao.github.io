		...
		xmlhttp.onreadystatechange = function (){
			if (xmlhttp.readyState==4){// 4 = "loaded"
				...
				if (xmlhttp.status==200){// 200 = "OK"
					...
					var converter = new Showdown.converter();
					content.innerHTML = '<div style="padding: 20px 20px 20px 40px;"><div id="back_home"><a href="/" onclick="home();return false;">'+'文章'+'</a><span>&nbsp;›&nbsp;</span></div><div id="post_title">' + decodeUtf8(path.substr(1).split('/')[path.substr(1).split('/').length-1].replace(/_/g, ' ')) + (encoded?Base64.decode('PHN1cCBzdHlsZT0iZm9udC1zaXplOjAuNWVtO3ZlcnRpY2FsLWFsaWduOiBzdXBlcjsiIHRpdGxlPSLmraTmlofnq6Dlt7Looqvph43mlrDnvJbnoIHku6XourLpgb/lrqHmn6UiPuKYmuiiq+e8lueggeeahOWGheWuuTwvc3VwPg=='):'') + '</div>' + converter.makeHtml(blog_text) + '<div class="date"><span></span>发表于 ' + pdate + '</div>'+'<div class="jiathis_style"><a class="jiathis_button_weixin"><span class="jiathis_txt jtico jtico_weixin"></span></a><a class="jiathis_button_douban"><span class="jiathis_txt jtico jtico_douban"></a><a class="jiathis_button_fb"><span class="jiathis_txt jtico jtico_fb"></span></a><a class="jiathis_button_googleplus"><span class="jiathis_txt jtico jtico_googleplus"></a><a class="jiathis_button_tumblr"><span class="jiathis_txt jtico jtico_tumblr"></span></a><a class="jiathis_button_tsina"><span class="jiathis_txt jtico jtico_tsina"></span></a><a href="http://www.jiathis.com/share" class="jiathis jiathis_txt jtico jtico_jiathis" target="_blank"></a>'+'</div>';
					if(dis){
...
function showpost(path){
	...
	pdate = path.substr(1).split('/')[0]+'年'+path.substr(1).split('/')[1]+'月'+path.substr(1).split('/')[2]+'日';
	loadXMLDoc(url);
}
